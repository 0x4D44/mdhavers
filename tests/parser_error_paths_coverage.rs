...
fn parser_exercises_common_error_paths_for_coverage() {
    let cases = [
        ...
        (
            "function_param_name_must_be_identifier",
            "dae foo(1) { gie 1 }",
        ),
        (
            "function_default_param_expr_error",
            "dae foo(a = ) { gie a }",
        ),
        (
        ...
        (
            "class_method_invalid_signature",
            "kin C { dae () { gie 1 } }",
        ),
        ...
        (
            "ternary_condition_expr_error",
            "ken x = gin ) than 1 ither 2",
        ),
        ...
        (
            "match_arm_block_body_parse_error",
            "keek 1 { whan 1 -> { blether 1",
        ),
        (
            "match_arm_range_end_expr_error",
            "keek 1 { whan 1.. ) -> 1 }",
        ),
        ("match_arm_expr_body_parse_error", "keek 1 { whan 1 -> ) }"),
        (
            "match_arm_print_missing_expr",
            "keek 1 { whan 1 -> blether }",
        ),
        ("print_requires_stmt_end", "blether 1 2"),
        (
            "match_arm_break_missing_stmt_end",
            "keek 1 { whan 1 -> brak 1 }",
        ),
        (
            "match_arm_continue_missing_stmt_end",
            "keek 1 { whan 1 -> haud 1 }",
        ),
        (
            "match_arm_return_invalid_expr",
            "keek 1 { whan 1 -> gie ) }",
        ),
        ...
        (
            "else_if_parse_error",
            "gin aye { blether 1 } ither gin ) { blether 1 }",
        ),
        ...
        (
            "for_variable_must_be_identifier",
            "fer 1 in 0..3 { blether 1 }",
        ),
        ...
        (
            "try_catch_error_name_must_be_identifier",
            "hae_a_bash { } gin_it_gangs_wrang 1 { }",
        ),
        (
            "try_catch_missing_catch_block",
            "hae_a_bash { } gin_it_gangs_wrang e brak",
        ),
        ...
        (
            "dict_second_key_missing_colon",
            "ken d = {\"a\": 1, \"b\" 2}",
        ),
        (
            "dict_second_value_expr_error",
            "ken d = {\"a\": 1, \"b\": )}",
        ),
        ("block_expr_missing_right_brace", "ken x = { ken y = 1"),
        ("lambda_missing_right_pipe", "ken f = |x, y x"),
        (
            "lambda_block_missing_right_brace",
            "ken f = |x| { ken y = 1",
        ),
...
"#,
        ...
        (
            "compound_assign_subtract_value_expr_error",
            "ken x = 1\nx -= )",
        ),
        (
            "compound_assign_multiply_value_expr_error",
            "ken x = 1\nx *= )",
        ),
        (
            "compound_assign_divide_value_expr_error",
            "ken x = 1\nx /= )",
        ),
