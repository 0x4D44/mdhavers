...
**Date:** 2025-12-26  
**Repo (HEAD):** `mdhavers` (`d343125b1143160320a4a52030a7a58497a52cdc`)  
...
|---|---:|---:|---:|
| `src/interpreter.rs` | 14,576 / 14,827 | 251 | 98.31% |
| `src/llvm/codegen.rs` | 27,745 / 27,849 | 104 | 99.63% |
| `src/wasm_compiler.rs` | 1,156 / 1,165 | 9 | 99.23% |
| `src/llvm/compiler.rs` | 517 / 523 | 6 | 98.85% |
| `src/parser.rs` | 1,682 / 1,686 | 4 | 99.76% |
